    ...
    >
      <div className={`p-4 transition-transform duration-300 transform`}>
        <div className="card-wrapper">
          ...
          {/* Product Actions */}
          <div
            className={`product-actions flex items-center w-full justify-center gap-3 -mt-14 mb-10 transition-transform duration-300 ${cardHovered ? "-translate-y-0 opacity-100 visible" : "translate-y-full opacity-0 invisible"}`}
          >
